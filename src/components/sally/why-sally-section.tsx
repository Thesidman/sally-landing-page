    ...
    <section className="py-20 sm:py-32 bg-white/50">
      <div className="container mx-auto px-6">
        <div className="text-center max-w-3xl mx-auto">
          <Badge
            variant="outline"
            className="mb-4 text-sm font-semibold self-start bg-gradient-to-br from-green-50 to-white text-green-700 rounded-full px-4 py-1.5 border-green-200/60 shadow-sm"
          >
            <Sparkles className="size-3 mr-2 text-green-500" />
            Why Sally
          </Badge>
          <h2 className="font-headline text-4xl md:text-5xl font-medium text-foreground tracking-tight mt-4">
        ...
        {convos.map(c => (
          ...
          >
            <Image
              width={24}
              height={24}
              src={`https://picsum.photos/seed/${c.avatarSeed}/24/24`}
              alt={c.name}
            ...
            <Badge variant={c.color} className="text-xs">
              {c.status}
            </Badge>
          </div>
        ))}
  ...
  return (
    <div className="bg-gray-50/70 p-4 rounded-xl border border-gray-200/80">
      <div className="flex items-center justify-between mb-3">
        ...
        <Badge variant="primary" className="bg-primary/90 text-white">
          Book Meeting
        </Badge>
      </div>
...
const Card4Visual = () => (
  <div className="bg-gray-50/70 p-4 rounded-xl border border-gray-200/80 flex items-center gap-4">
    ...
    <div className="flex-1 grid grid-cols-2 gap-2 text-center">
      <div className="bg-white p-2 rounded-lg shadow-sm border border-gray-200/50">
        <p className="text-xs font-medium text-gray-700">Replies Sent</p>
      </div>
      <div className="bg-white p-2 rounded-lg shadow-sm border border-gray-200/50">
        <p className="text-xs font-medium text-gray-700">Meetings Booked</p>
      </div>
      <div className="bg-white p-2 rounded-lg shadow-sm border border-gray-200/50">
        <p className="text-xs font-medium text-gray-700">Issues Resolved</p>
      </div>
      <div className="bg-white p-2 rounded-lg shadow-sm border border-gray-200/50">
    ...
    <div className="bg-gray-50/70 p-4 rounded-xl border border-gray-200/80">
      ...
      <div className="space-y-2">
        {items.map(item => (
          <div
            key={item.text}
            className="flex items-center bg-white p-2 rounded-lg shadow-sm text-sm border border-gray-200/60"
          >
            <div
              className={cn(
                'size-6 flex items-center justify-center rounded-md mr-3',
                item.status === 'Done'
...
const Card6Visual = () => (
  <div className="bg-gray-50/70 p-4 rounded-xl border border-gray-200/80">
    <div className="space-y-2.5">
      <div className="p-2.5 rounded-lg bg-white shadow-sm text-sm text-gray-800 max-w-[85%] self-start border border-gray-200/60">
        What are you trying to accomplish?
      </div>
      <div className="flex justify-end">
        <p className="p-2.5 rounded-lg bg-white shadow-sm text-sm text-gray-800 max-w-[85%] border border-gray-200/60">
      ...
      <div className="flex items-start gap-3">
        ...
        <div className="p-2.5 rounded-lg bg-green-100/70 border border-green-200/80 text-sm text-green-900 max-w-[85%]">
